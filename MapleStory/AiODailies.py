...
##########################################################################
# Set Daily quest to True whichever you like to have
VJ_Daily = True
# VJ_Daily = False
# ChuChu_Daily = True
ChuChu_Daily = False
...
UseAA = True  # Set True if you want to use auto attack during Dream defender
UseSI = False  # Set True if you want to use SI during Dream defender
...
roundWaitTime = 2.5 #How long to wait when handing in spirits
