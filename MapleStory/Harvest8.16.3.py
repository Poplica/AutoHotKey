...
toMine = [blackvein, magentavein, purplevein] #Enter which vein/herb you want to mine/harvest.
...
class Rope(object):
    ...
    def toRope(self):
        ...
        while pos.x < (self.x - 55) or pos.x > (self.x + 55):
...
#-----#
firstRope = Rope(1210, 510, firstPlat)
secondRope = Rope(1055, 210, secondPlat)
thirdRope = Rope(450, -30, thirdPlat)
fourthRope = Rope(1366, -270, fourthPlat)
