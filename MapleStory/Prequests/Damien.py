...
while Terminal.IsRushing():
  time.sleep(2)
#if the script doesn't start , then go to henesys/leafre/a map that has a mirror in quick travel
"""WHEN A PATCH BREAKS THIS HEADER, REMOVE FROM HERE TO"""
if field_id >= 100000000 and field_id <= 340000000:
  oPacket = Packet.COutPacket(0x019F)
  oPacket.Encode2(0x0002)
  Packet.SendPacket(oPacket)
  time.sleep(1)
  oPacket = Packet.COutPacket(0x022E) 
  oPacket.EncodeBuffer("[020000000100000004000000]")
  Packet.SendPacket(oPacket)
if field_id == 350140000:
  time.sleep(30) #todo
  #oPacket = Packet.COutPacket(0x00E8)
  #oPacket.Encode1(0x28)
  #Packet.SendPacket(oPacket)
"""TO HERE, Manually start act 4 and activate script in team selection map instead"""  
if field_id == 350140100:	
  ...
  Terminal.SetCheckBox('Mob Vac', 1)
  ...
  Terminal.SetCheckBox('Mob Vac', 0)
  time.sleep(5)
